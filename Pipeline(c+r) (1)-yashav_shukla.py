...
import numpy as np
import pandas as pd
with open(r"C:\Users\YashavShukla\Desktop\LoanExport\classification_.pkl", 'rb') as file:
    classification_pipeline = pickle.load(file)

with open(r"C:\Users\YashavShukla\Desktop\LoanExport\regression_.pkl", 'rb') as file:
...
output_file_path = r"C:\Users\YashavShukla\Desktop\LoanExport\combined_predictions.pkl"
